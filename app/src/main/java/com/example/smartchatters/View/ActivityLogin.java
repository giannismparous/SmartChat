...
public class ActivityLogin extends AppCompatActivity implements  View.OnClickListener {
    ...
    private ImageButton attachProfilePic;
    private Intent myFileIntent;
    private final int chooseFinal = 1001;
    private String profilePicPath;
    private String profilePicExtension;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        attachProfilePic= (ImageButton)  findViewById(R.id.attachProfilePic);
        setListener();
    }
    ...
    public void onClick(View v){
        if (v.getId() == R.id.loginButton) {
            ...
            if (!user.trim().equals("")){
                ...
                intent.putExtra("profilePicExtension",profilePicExtension);
                startActivity(intent);
            }
        }
        else if (v.getId() == R.id.attachProfilePic){
        ...
        if (requestCode==chooseFinal) {
            if (resultCode == -1) {
                if (data.getData()!=null) {
                    ...
                    profilePicPath = path.substring(0,path.lastIndexOf("."));
                    profilePicExtension = path.substring(path.lastIndexOf(".")+1);
                }
            }
        }
    }
    ...
    private void setListener() {
        ...
        attachProfilePic.setOnClickListener(this);
    }
